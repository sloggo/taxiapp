...
public class MapUserIntegrationTest {
    ...
    @Test
    public void addCustomerToMapTest() throws IOException {
        Map map = new Map(5, "integrationTest", true);
    ...
    @Test
    public void addTaxiToMapTest() throws IOException {
        Map map = new Map(5, "integrationTest", true);
    ...
    @Test
    public void addBothToMapTest() throws IOException {
        Map map = new Map(5, "integrationTest", true);
        Customer customer = new Customer("customerTest", map, 1,1);
        Taxi taxi = new Taxi("taxiTest", map, 1,1);
    ...
    @Test
    public void mapTaxiLoggingTest() throws IOException {
        Map map = new Map(5, "integrationTest", true);
        Customer customer = new Customer("customerTest", map, 1,1);
    ...
    @Test
    public void mapCustomerLoggingTest() throws IOException {
        Map map = new Map(5, "integrationTest", true);
        Taxi taxi = new Taxi("taxiTest", map, 1,1);
